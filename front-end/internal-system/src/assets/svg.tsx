...
export const DangerIcon = () => {
	return (
		<svg
			...
			viewBox="0 0 24 24"
			fill="currentColor"
			className="ml-2 h-7 w-7 text-error-500"
		>
			<path
				fillRule="evenodd"
	...
	return (
		...
		>
			...
			<path
				...
				strokeLinejoin="round"
			/>
			<path d="M12 12H20" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M12 18H20" strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	);
};
