...
export default function VisitorFormLayout({ record }: VisitorDeetsProps) {
	...
	const { qr_id } = useParams(); // QR ID, assuming it looks like this, this retrieves the value of qr
